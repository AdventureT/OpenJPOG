...
TBOOL PPropertyValueArray::GetTQuaternion(TQuaternion &a_rQuat) const
{
	...
	if (type == PPropertyValue::TYPE_INT) {
		fValue = TFLOAT(m_oValues[0].GetInteger());
	}
	if (type == PPropertyValue::TYPE_UINT32) {
		fValue = TFLOAT(m_oValues[0].GetUINT32());
	}
	...
	fValue = 0.0f;
	if (type == PPropertyValue::TYPE_INT) {
		fValue = TFLOAT(m_oValues[1].GetInteger());
	}
	if (type == PPropertyValue::TYPE_UINT32) {
		fValue = TFLOAT(m_oValues[1].GetUINT32());
	}
	if (type == PPropertyValue::TYPE_FLOAT) {
	...
	fValue = 0.0f;
	if (type == PPropertyValue::TYPE_INT) {
		fValue = TFLOAT(m_oValues[2].GetInteger());
	}
	if (type == PPropertyValue::TYPE_UINT32) {
		fValue = TFLOAT(m_oValues[2].GetUINT32());
	}
	if (type == PPropertyValue::TYPE_FLOAT) {
	...
	fValue = 0.0f;
	if (type == PPropertyValue::TYPE_INT) {
		fValue = TFLOAT(m_oValues[3].GetInteger());
	}
	else if (type == PPropertyValue::TYPE_UINT32) {
		fValue = TFLOAT(m_oValues[3].GetUINT32());
	}
