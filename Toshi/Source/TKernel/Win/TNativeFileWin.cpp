...
TNativeFileSystem::TNativeFileSystem(TPCCHAR a_pcName) : TFileSystem(a_pcName)
{
...
TNativeFile::TNativeFile(TNativeFileSystem* a_pFileManager) : TFile(a_pFileManager)
{
