...
extern "C" {
    ...
    typedef void* (*THEORAPLAY_tAllocator)(size_t size);
    static THEORAPLAY_tAllocator THEORAPLAY_sAllocate;

    typedef void(*THEORAPLAY_tDeallocator)(void* ptr);
    static THEORAPLAY_tDeallocator THEORAPLAY_sDeallocate;
