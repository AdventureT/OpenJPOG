...
def main():
    cpp_files = []
    cpp_files.extend(find_cpp_files('D:\\_dev\\OpenJPOG\\Toshi'))
    cpp_files.extend(find_cpp_files('D:\\_dev\\OpenJPOG\\OpenJPOG'))
        ...
        try:
            if 'Profiler' not in file:
                ...
                subprocess.call([
                    ...
                    file,
                    '--',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Include\\TApplication',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Include\\TKernel',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Include\\TRender',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Include\\TRenderD3D',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Include\\TTerrain',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Include\\TGui',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Plugins\\Include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Shaders\\TSpriteShader\\Include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Shaders\\TSpriteShader\\Include\\D3D',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Shaders\\TSysShader\\Include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Shaders\\TSysShader\\Include\\D3D',
                    r'-ID:\\_dev\\OpenJPOG\\OpenJPOG\\Source',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Vendor\\bink\\include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Vendor\\curl\\include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Vendor\\DX81\\include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Vendor\\fmod\\include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Vendor\\glew\\include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Vendor\\glm\\include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Vendor\\Opcode\\Source',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Vendor\\sdl2\\include',
                    r'-ID:\\_dev\\OpenJPOG\\Toshi\\Vendor\\stb',
                    '--language=c++',
                    '-includeToshi/Toshi.h',
                    '-std=c++20',
                    '-DTOSHI_SKU_WINDOWS',
    ...
    with open(f'functions_with_signatures_{project_name}.csv', 'r') as file:
        csv_reader = csv.reader(file)
        for row in csv_reader:
            name = row[0]
            address = row[1]
            ...
            if type != "Function" or name.startswith("?") or address.startswith("External"):
                continue
                    ...
                    if assumed_method != None:
                        ...
                        for i in range(decl_line - 1, 0, -1):
                            ...
                            if line.startswith('//'):
                                ...
                                if comment.startswith(f'${project_name}: FUNCTION'):
                                    has_marker = True
                                    marker_line = i + 1
                        ...
                        if not has_marker:
                            ...
                            source_code_lines.insert(marker_line, f'{num_tabs * '\t'}{num_spaces * ' '}// ${project_name}: FUNCTION {address}\n')
